    ...
    <section className="border-border border-b">
      <div className="flex items-center justify-between gap-2 px-4 py-3">
        ...
        <Button
          ...
          className="text-muted-foreground hover:text-foreground aria-expanded:text-muted-foreground aria-expanded:hover:text-foreground hover:bg-transparent aria-expanded:bg-transparent dark:hover:bg-transparent"
