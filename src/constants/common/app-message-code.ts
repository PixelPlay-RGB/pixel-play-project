...
export const APP_MESSAGE_CODE = {
  success: {
    ...
    channel: {
      ...
      subscriptionEmoteSaved: "success.channel.subscriptionEmoteSaved",
  ...
  error: {
    ...
    channel: {
      ...
      subscriptionEmoteSaveFailed: "error.channel.subscriptionEmoteSaveFailed",
      subscriptionEmoteImageInvalid: "error.channel.subscriptionEmoteImageInvalid",
      subscriptionEmoteTitleInvalid: "error.channel.subscriptionEmoteTitleInvalid",
      subscriptionEmoteLimitReached: "error.channel.subscriptionEmoteLimitReached",
