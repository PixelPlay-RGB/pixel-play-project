...
export default function LiveCard({ item }: LiveCardProps) {
  ...
  return (
    <Link
      ...
      className="group bg-card text-card-foreground focus-visible:ring-ring overflow-hidden rounded-lg border shadow-sm transition outline-none hover:-translate-y-0.5 hover:shadow-md focus-visible:ring-3"
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-black">
        ...
        <span className="absolute top-3 right-3 rounded-full bg-black/60 px-2 py-1 text-xs font-semibold text-white backdrop-blur">
      ...
      <div className="flex gap-3 p-3">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          <div className="min-w-0 space-y-1">
            <h3 className="text-foreground line-clamp-2 text-sm leading-snug font-bold wrap-break-word">
              {item.title}
            </h3>
