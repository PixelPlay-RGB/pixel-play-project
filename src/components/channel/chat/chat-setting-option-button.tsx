  ...
  return (
    <RadioGroupItem
      ...
      className={cn(
        ...
        "data-checked:border-brand data-checked:bg-brand data-checked:shadow-brand/25 data-checked:hover:bg-brand/90 data-checked:text-brand-foreground data-checked:shadow-sm",
