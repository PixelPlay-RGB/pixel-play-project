  ...
  return (
    <div className="flex flex-col gap-5 xl:flex-row xl:items-start">
      <div className="flex min-w-0 flex-1 flex-col gap-5">
        <SettingsCard
          title="등록한 구독뱃지"
          description="구독 기간별 채팅 뱃지를 확인하고 필요한 구간의 이미지를 등록해요."
          action={
        ...
        >
          ...
          <p className="text-muted-foreground text-xs">
            기본 구독뱃지 슬롯은 1개월과 동일하며, 필요한 개월 수는 등록 창에서 직접 선택하거나
            입력할 수 있어요.
          </p>
        </SettingsCard>
        ...
        <SettingsCard
          title="구독자에게 이렇게 보여요"
          description="구독자가 채팅에서 보게 되는 구독뱃지 미리보기예요. 등록과 수정 내용은 저장 후 반영돼요."
        >
      ...
      <div className="flex min-w-0 flex-col gap-5 xl:w-120 xl:shrink-0">
        <SideTipCard
          ...
          title="뱃지를 등록하기 전에 확인해요"
          description="구독뱃지는 채팅에서 작은 크기로 보이므로 선명한 정사각형 PNG 파일로 준비해주세요."
        >
          <SideTipStep
            number="1"
            title="이미지 규격"
          ...
          <SideTipStep
            number="2"
            title="등록과 검수"
            description="신청한 구독뱃지는 기본적인 검수 진행 후 1일 1회 일괄 등록 예정입니다."
          />
          <SideTipStep
            number="3"
            title="기본 슬롯 관리"
            description="기본 구독뱃지 슬롯은 1개월과 동일하며 이미지 등록 및 수정, 삭제가 가능합니다."
          />
          <SideTipStep
            number="4"
            title="개월 수 설정"
  ...
  return (
    <div className="flex min-w-0 flex-col items-center gap-2">
      ...
      <span
        className={
          compact
            ? "text-muted-foreground text-xs leading-none whitespace-nowrap"
            : "text-foreground text-sm leading-none font-bold whitespace-nowrap"
        }
      >
        {month}개월
      </span>
