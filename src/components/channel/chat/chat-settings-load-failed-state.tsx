// 채널 채팅 설정을 불러오지 못한 상태를 렌더링합니다.

import { APP_MESSAGE_CODE } from "@/constants/common/app-message-code";
import { getAppMessage } from "@/utils/common/app-message";
import { TriangleAlert } from "lucide-react";

export function ChatSettingsLoadFailedState() {
  const message = getAppMessage(APP_MESSAGE_CODE.error.channel.chatSettingsLoadFailed);
