  ...
  return (
    <section className="flex min-w-0 flex-col gap-3">
      <div className="flex items-center gap-2">
        <Vote className="text-brand size-4" />
        <h3 className="text-foreground text-sm font-bold">투표 만들기</h3>
      </div>
          ...
          <DialogTrigger
            render={
              <Button
                type="button"
                className={cn(
                  "bg-brand hover:bg-brand/90 shadow-brand/20 mt-auto h-10 rounded-xl text-sm font-bold text-white shadow-sm",
                  "active:scale-95",
                )}
              />
            }
