      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            ...
            "origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg p-1",
            "bg-popover text-popover-foreground ring-foreground/10 shadow-md ring-1 outline-none",
